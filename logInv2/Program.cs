...
var connectionString = builder.Configuration.GetConnectionString("AccountDbConnection") ?? throw new InvalidOperationException("Connection string 'AccountDbConnection' not found.");
